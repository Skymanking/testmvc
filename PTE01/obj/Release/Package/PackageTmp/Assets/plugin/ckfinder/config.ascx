...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        //LicenseName = "alibaba";
        //LicenseKey = "53FJLP2Y9BVR1F7NVSQKQLR5MQRSLX71";
        LicenseName = "hoangthangit";
        LicenseKey = "AUHY8CHAXFS5KYW9X7KLYMY4QGWTRF37";

        string linktemp = Session["FOLDERPATH_SESSION"].ToString();
        // The base URL used to reach files in CKFinder through the browser.
        //BaseUrl = "/CV/";
            BaseUrl ="/Data/"+ linktemp+"/";
