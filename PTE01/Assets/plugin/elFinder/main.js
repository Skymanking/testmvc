...
(function(){
	var // jQuery and jQueryUI version
		...
		opts = {
		    url: '/Assets/Admin/plugin/elFinder/php/connector.php', // connector URL (REQUIRED)
		...
		start = function(elFinder) {
			// load jQueryUI CSS
		    elFinder.prototype.loadCss('/Assets/Admin/plugin/elFinder/jquery-ui.css');
	...
	require.config({
	    baseUrl: '/Assets/Admin/plugin/elFinder/js',
		paths : {
			'jquery'   : 'jquery.min',
